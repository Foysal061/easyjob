...
<div class="container">
	...
	<div class="sixteen columns">
		<h3 class="headline centered margin-bottom-35 margin-top-60">Popular Cities <span>Browse job offers by popular locations</span></h3>
	</div>
	
	<div class="one-third column">

		<!-- Image Box -->
		<a href="browse-jobs.html" class="img-box" data-background-image="images/popular-location-01.jpg">
	...
	<div class="two-thirds column">
		...
		<!-- Image Box -->
		<a href="browse-jobs.html" class="img-box" data-background-image="images/popular-location-02.jpg">
			<div class="img-box-content visible">
				<h4>Los Angeles</h4>
				<span>24 Jobs</span>
			</div>
	...
	<div class="two-thirds column">
		...
		<!-- Image Box -->
		<a href="browse-jobs.html" class="img-box" data-background-image="images/popular-location-03.jpg">
			<div class="img-box-content visible">
				<h4>San Francisco </h4>
				<span>12 Jobs</span>
			</div>
	...
	<div class="one-third column">
		...
		<!-- Image Box -->
		<a href="browse-jobs.html" class="img-box" data-background-image="images/popular-location-04.jpg">
			<div class="img-box-content visible">
				<h4>Miami</h4>
				<span>9 Jobs</span>
			</div>
